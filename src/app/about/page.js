        ...
        <div className="about-hero-pin">
          <div className="hero-heading">
            <Copy animateOnScroll={false} delay={0.85}>
              <h1 className="heading-line-1">MARY</h1>
              <h1 className="heading-line-2">JANE</h1>
              <h1 className="heading-line-3">STORY</h1>
            </Copy>
          </div>

          <div className="hero-image">
            <img src="/about/about-hero.jpg" alt="About Mary Jane" />
          </div>
        </div>
      </section>
      ...
      <section className="about-info">
        <div className="container">
          <Copy>
            ...
            <h3>
              Mary Jane is an exercise in quiet composition—where space, light,
              and tone meet with deliberate restraint in every photograph.
            </h3>
            <h3>
              Sessions are guided by clarity and patience: each frame is
              considered, each edit composed to feel complete yet effortless.
            </h3>
          </Copy>
        </div>
      </section>
