      ...
      <div className="container">
        <div className="cta-content">
          <Copy type="lines" animateOnScroll trigger=".cta" start="top 80%">
            <h6>Your next frame</h6>
          </Copy>

          <Copy type="lines" animateOnScroll trigger=".cta" start="top 80%">
            <h5>
              Portrait, editorial, and on-location work—paced with care so each
              image lands with quiet intention.
            </h5>
          </Copy>
          ...
          <div className="cta-details">
            <div className="cta-address">
              <Copy
                ...
                delay={0.3}
              >
                <p className="mono">Studio & on location</p>
                <p className="mono">By appointment</p>
              </Copy>
            </div>
            <div className="cta-hours">
              <Copy
                ...
                delay={0.3}
              >
                <p className="mono">MON–FRI 10:00–18:00</p>
                <p className="mono">WEEKENDS ON REQUEST</p>
              </Copy>
            </div>
          </div>
        ...
        <div className="cta-image">
          <img src="/cta/cta-img.jpg" alt="Photography session" />
        </div>
      </div>
    </section>
  );
