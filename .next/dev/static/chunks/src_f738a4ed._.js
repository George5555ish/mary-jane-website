...
"[project]/src/app/reservation/page.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const INFO_CARDS = [
    ...
    {
        icon: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2d$icons$2f$hi2$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["HiMoon"],
        title: "Contact",
...
function Reservation() {
    ...
    const infoSectionRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    const heroButtonRef = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRef"])(null);
    ...
    const [rebuildKey, setRebuildKey] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(0);
    /* track breakpoint changes */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Reservation.useEffect": ()=>{
            const handleResize = {
                "Reservation.useEffect.handleResize": ()=>setIsDesktop(window.innerWidth >= MOBILE_BREAKPOINT)
            }["Reservation.useEffect.handleResize"];
            handleResize();
            window.addEventListener("resize", handleResize);
            return ({
                "Reservation.useEffect": ()=>window.removeEventListener("resize", handleResize)
            })["Reservation.useEffect"];
        }
    }["Reservation.useEffect"], []);
    /* rebuild after view transition settles */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Reservation.useEffect": ()=>{
            const handleTransitionComplete = {
                "Reservation.useEffect.handleTransitionComplete": ()=>setRebuildKey({
                        "Reservation.useEffect.handleTransitionComplete": (prev)=>prev + 1
                    }["Reservation.useEffect.handleTransitionComplete"])
            }["Reservation.useEffect.handleTransitionComplete"];
            window.addEventListener("viewTransitionComplete", handleTransitionComplete);
            return ({
                "Reservation.useEffect": ()=>window.removeEventListener("viewTransitionComplete", handleTransitionComplete)
            })["Reservation.useEffect"];
        }
    }["Reservation.useEffect"], []);
    /* hero button entrance animation */ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Reservation.useEffect": ()=>{
            const buttonWrapper = heroButtonRef.current;
            if (!buttonWrapper) return;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(buttonWrapper, {
                autoAlpha: 0,
                y: 40
            }, {
                autoAlpha: 1,
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$gsap$2f$react$2f$src$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useGSAP"])({
        "Reservation.useGSAP": ()=>{
            ...
            const panels = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray(infoSection.querySelectorAll(".info-panel"));
            const cards = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray(infoSection.querySelectorAll(".info-card"));
            /* panels slide up with icon scale-in */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].create({
                trigger: infoSection,
                start: "top bottom",
                end: "top top",
                scrub: 1,
                onUpdate: {
                    "Reservation.useGSAP": (self)=>{
                        const progress = self.progress;
                        panels.forEach({
                            "Reservation.useGSAP": (panel, index)=>{
                                ...
                                if (progress >= start && progress <= end) {
                                    ...
                                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].set(panel.querySelector(".info-panel-icon"), {
                                        scale: 1
                                    });
                                }
                            }
            ...
            /* cards fan in from right, then scale up */ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].create({
                trigger: infoSection,
                start: "top top",
                ...
                onUpdate: {
                    "Reservation.useGSAP": (self)=>{
                        const progress = self.progress;
                        cards.forEach({
                            "Reservation.useGSAP": (card, index)=>{
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Fragment"], {
        children: [
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("section", {
                ...
                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    className: "container",
                    children: INFO_CARDS.map(({ icon: Icon, title, description, items })=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                            ...
                                            children: items.map((item)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                    className: "mono",
                                                    children: item
                                                }, item, false, {
                                                    fileName: "[project]/src/app/reservation/page.js",
...
_s(Reservation, "sq1NRBtJ/LsZTgzdqtVrriFFTGM=", false, function() {
    return [
...
//# sourceMappingURL=src_f738a4ed._.js.map